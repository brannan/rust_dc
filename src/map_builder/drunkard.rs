...
impl DrunkardsWalkArchitect {
    ...
    fn drunkard(&mut self, start: &Point, rng: &mut RandomNumberGenerator, map: &mut Map) {
        ...
        loop {
            ...
            // TODO Because map is wider than it is tall, we rarely reach the widths
            map.tiles[drunk_idx] = TileType::Floor;
            match rng.range(0, 10) {
                0..=2 => drunkard_pos.x -= 1,
                3..=5 => drunkard_pos.x += 1,
                7..=8 => drunkard_pos.y -= 1,
                _ => drunkard_pos.y += 1,
            }
...
mod tests {
    ...
    fn make_map_builder() -> MapBuilder {
